...
RUN rpm-ostree install distrobox gnome-tweaks just htop powertop fastfetch btop vim tlp akmod-nvidia xorg-x11-drv-nvidia xorg-x11-drv-nvidia-cuda figlet lolcat && \
